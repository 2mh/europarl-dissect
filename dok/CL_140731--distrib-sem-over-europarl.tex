...
\hspace{-6cm}\begin{tikzpicture}
    ...
    \end{axis}
\end{tikzpicture}
\caption{Anzahl Types}
\label{fig:numOfWords}
\end{figure}

Während die Anzahl der Types grundsätzlich verschieden ist zwischen den Sprachen, gibt es mit der Oberflächenform in beiden Sprachen etwa gleich viele Wortpaarungen (siehe Abbildung \ref{fig:numOfWords}) innerhalb der Sprache. In diesen Fällen waren auch die Übersetzungskandidaten besonders gut. Die Verhältnisse lassen sich der Abbildung \ref{fig:ratio} entnehmen:
...
\hspace{-6cm}\begin{tikzpicture}
    ...
    \end{axis}
\end{tikzpicture}
\caption{Verhältnisse verschiedener Paarungen}
\label{fig:ratio}
\end{figure}

\paragraph{Übersetzungskandidaten EN--DE mit 30\,000 Trainingssätzen über Wortoberflächen\\\\}
In der Übersetzungsrichtung Englisch-Deutsch konnten die besten Resultate mit einem Trainingskorpus von 30\,000 Sätzen erreicht werden. Die konkreten Vorschläge mit und ohne gute Kandidaten lässt sich der untenstehenden Tabelle entnehmen. Die Eingabewörter, für die keine gute Übersetzung gefunden wurde, sind dabei rot eingefärbt.
...
Deutsch--Englisch (in beide Übersetzungsrichtungen) gute Vorschläge in bis zu knapp über 70\% der betrachteten Fälle zu finden, die sich dadurch eignen,
das System als Desambiguierungswerkzeug -- z. B. für Maschinelle Übersetzung -- zu verwenden.

Auf der Ebene der Wortoberflächen entstehen ebenfalls als sinnvoll betrachbare semantische Netze, wenn nur deutsche oder englische
...
Als mögliches Gebiet zur Weiterarbeit steht einerseits sicherlich die Wahl der Sprachen zur Verfügung, wobei es interessant wäre mit zwei in morphologischer
