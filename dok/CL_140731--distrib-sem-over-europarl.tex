...
\hspace{-4cm}\begin{tikzpicture}
    \begin{axis}[
        ...
        \addplot            coordinates {(150k, 1.0) (100k,1.0) (50k,1.0) (20k,4) (10k,4) (5k,3)};
        \addplot            coordinates {(150k, 1.0) (100k,1.0) (50k,1.0) (20k,4) (10k,4) (5k,3)};
        \addplot            coordinates {(150k, 1.0) (100k,1.0) (50k,1.0) (20k,4) (10k,4) (5k,3)};
        \addplot            coordinates {(150k, 1.0) (100k,1.0) (50k,1.0) (20k,4) (10k,4) (5k,3)};
...
\begin{tikzpicture}
\begin{axis}[
        height=9cm, width=12cm, grid=major,
    ycomb, %ybar interval,
    ...
    tickpos=left,
    xtick={1,2,3,4,5},
    xticklabels={150k, 100k, 50k, 10k, 5k},
    ymin=0,
    legend entries={Oberfläche,Lemmata},
    %ytick={1000,2000,3000,4000,5000,6000,7000,8000,9000,10000},
    %yticklabels={1\,000,2\,000,3\,000,4\,000,5\,000,6\,000,7\,000,8\,000,9\,000,10\,000}
    ]
% swe
\addplot coordinates {(1,1) (2,2) (3,0) (4,4) (5,7)};
% ice:
\addplot coordinates {(1,1) (2,2) (3,0) (4,4) (5,7)};
\end{axis}
\end{tikzpicture}
